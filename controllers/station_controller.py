...
class StationController:
    def __init__(self):
        ...
        self.charging_stations = {
            "Posto 1": {"x": 2.0, "y": 3.0, "ocupado": False, "tempo_expiracao": None,"id": None},
            "Posto 2": {"x": 5.0, "y": 7.0, "ocupado": False, "tempo_expiracao": None,"id": None},
            "Posto 3": {"x": 8.0, "y": 2.0, "ocupado": False, "tempo_expiracao": None,"id": None},
            "Posto 4": {"x": 1.0, "y": 9.0, "ocupado": False, "tempo_expiracao": None,"id": None},
            "Posto 5": {"x": 6.0, "y": 5.0, "ocupado": False, "tempo_expiracao": None,"id": None},
        }
